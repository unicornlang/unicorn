...
Unicorn is a programming language that trancompiles to object oriented C code that is idiomatic and readable. It's primarily meant as a subset of C useful for web assembly but it's a generally useful subset for other purposes. Unicorn can be used side by side with C99.
